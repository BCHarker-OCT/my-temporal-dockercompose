...
- [Temporal Dockerfile Cluster](#temporal-dockerfile-cluster)
  - [📋 Table of Contents](#-table-of-contents)
  - [About](#about)
    - [Dynamic config](#dynamic-config)
  - [Deploying your service](#deploying-your-service)
    - [How to start](#how-to-start)
    - [Using startup.sh (recommended)](#using-startupsh-recommended)
    - [Manual docker compose flow](#manual-docker-compose-flow)
  - [Check if it works](#check-if-it-works)
    ...
    - [Http API](#http-api)
    - [Parsing static config since server release 1.30](#parsing-static-config-since-server-release-130)
    - [Links](#links)
    - [Custom docker template](#custom-docker-template)
  ...
  - [MinIO Archival](#minio-archival)
    ...
    - [Querying archived workflows](#querying-archived-workflows)
    - [Controlling which statuses are archived](#controlling-which-statuses-are-archived)
